...
namespace WindowsFormsApplication14
{
    ...
    public partial class Form1 : Form
    {
        ...
        decimal partsChargesDec, subTotalDec, 
            salesTaxDec, totalDec, laborChargesDec,
            summarySalesTaxDec, summarySubTotalDec, summaryTotalDec;
        ...
        public Form1()
        {
            ...
            number = 1;
            //Intialize the label to 1 as well
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    //calculate by using what customer selected, match with prices here
                    ...
                    //Increase job number, increment the number
                    number++;
                    ...
                    // running total of sales tax, subtotal, total for all customers
                    summarySalesTaxDec += salesTaxDec;
                    summarySubTotalDec += subTotalDec;
                    summaryTotalDec += totalDec;
                }
        ...
        private void summaryButton_Click(object sender, EventArgs e)
        {
            ...
            // send info to the summary form.
            aSummaryForm.SummarySubTotal = summarySubTotalDec;
            aSummaryForm.SummarySalesTax = summarySalesTaxDec;
            aSummaryForm.SummaryTotal = summaryTotalDec;

            // make modal summary form.
