...
namespace WindowsFormsApplication14
{
    ...
    public partial class Form1 : Form
    {
        ...
        decimal partsChargesDec, subTotalDec, 
            ...
            summarySalesTaxDec, summarySubTotalDec;
        ...
        */
        ...
        {
            richTextBox1.Text = "subtotal" + summarySubTotalDec.ToString("c") + "sales tax" + summarySalesTaxDec.ToString("c");
        }
